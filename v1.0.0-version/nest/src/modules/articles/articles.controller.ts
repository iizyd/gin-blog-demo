...
export class ArticlesController {
  ...
  @Get()
  async findAll(
    @Query() listArticleDto: ListArticleDto,
    @Pager() pager: Pager,
  ) {
    const list = await this.articlesService.findAll(listArticleDto, pager);
    const total = await this.articlesService.count(listArticleDto);
